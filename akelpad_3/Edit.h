...
#define APP_ABOUT_VERSIONA           "AkelPad 3.6.2"
#define APP_ABOUT_VERSIONW          L"AkelPad 3.6.2"
...
typedef struct _IRichEditOleCallbackVtbl {
  ...
  HRESULT (WINAPI *GetNewStorage)(LPUNKNOWN, LPSTORAGE FAR *);
  HRESULT (WINAPI *GetInPlaceContext)(LPUNKNOWN, LPOLEINPLACEFRAME FAR *, LPOLEINPLACEUIWINDOW FAR *, LPOLEINPLACEFRAMEINFO);
  HRESULT (WINAPI *ShowContainerUI)(LPUNKNOWN, BOOL);
  HRESULT (WINAPI *QueryInsertObject)(LPUNKNOWN, LPCLSID, LPSTORAGE, LONG);
  HRESULT (WINAPI *DeleteObject)(LPUNKNOWN, LPOLEOBJECT);
  HRESULT (WINAPI *QueryAcceptData)(LPUNKNOWN, LPDATAOBJECT, CLIPFORMAT FAR *, DWORD, BOOL, HGLOBAL);
  HRESULT (WINAPI *ContextSensitiveHelp)(LPUNKNOWN, BOOL);
  HRESULT (WINAPI *GetClipboardData)(LPUNKNOWN, CHARRANGE FAR *, DWORD, LPDATAOBJECT FAR *);
  HRESULT (WINAPI *GetDragDropEffect)(LPUNKNOWN, BOOL, DWORD, LPDWORD);
  HRESULT (WINAPI *GetContextMenu)(LPUNKNOWN, WORD, LPOLEOBJECT, CHARRANGE FAR *, HMENU FAR *);
} IRichEditOleCallbackVtbl;

typedef struct _REOLE {
  IRichEditOleCallbackVtbl *lpTable;
  ULONG uRefCount;
} REOLE;
