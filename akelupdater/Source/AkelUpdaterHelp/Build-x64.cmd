...
rc /R /DRC_VERSIONBIT=%BIT% /Fo"AkelUpdaterHelp.res" "Resources\AkelUpdaterHelp.rc"
if not %ERRORLEVEL% == 0 set EXITCODE=%ERRORLEVEL%
cl /O1 %CLFLAGS% AkelUpdaterHelp.c AkelUpdaterHelp.res /link kernel32.lib user32.lib /SUBSYSTEM:WINDOWS /OPT:NOWIN98 /MACHINE:%MACHINE% /NODEFAULTLIB /ENTRY:_WinMain
if not %ERRORLEVEL% == 0 set EXITCODE=%ERRORLEVEL%
