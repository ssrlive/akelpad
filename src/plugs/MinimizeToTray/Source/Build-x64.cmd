...
rc /R /DRC_VERSIONBIT=%BIT% /Fo"MinimizeToTray.res" "Resources\MinimizeToTray.rc"
if not %ERRORLEVEL% == 0 set EXITCODE=%ERRORLEVEL%
cl /O1 %CLFLAGS% MinimizeToTray.c MinimizeToTray.res /LD /link kernel32.lib user32.lib shell32.lib /OPT:NOWIN98 /MACHINE:%MACHINE% /NODEFAULTLIB /ENTRY:DllMain
if not %ERRORLEVEL% == 0 set EXITCODE=%ERRORLEVEL%
