...
rc %RCFLAGS% /R /DRC_VERSIONBIT=%BIT% /Fo"Macros.res" "Resources\Macros.rc"
if not %ERRORLEVEL% == 0 set EXITCODE=%ERRORLEVEL%
cl %CLFLAGS% Macros.c Macros.res /LD /link kernel32.lib user32.lib comctl32.lib comdlg32.lib %LINKFLAGS% /OPT:NOWIN98 /MACHINE:%MACHINE% /NODEFAULTLIB /ENTRY:DllMain
if not %ERRORLEVEL% == 0 set EXITCODE=%ERRORLEVEL%

::### Clean up ###::
if exist Macros.res del Macros.res
if exist Macros.obj del Macros.obj
if exist Macros.lib del Macros.lib
if exist Macros.exp del Macros.exp
if exist Macros.ilk del Macros.ilk
