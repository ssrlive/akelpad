...
rc %RCFLAGS% /R /DRC_VERSIONBIT=%BIT% /Fo"Sessions.res" "Resources\Sessions.rc"
if not %ERRORLEVEL% == 0 set EXITCODE=%ERRORLEVEL%
cl %CLFLAGS% Sessions.c Sessions.res /LD /link kernel32.lib user32.lib gdi32.lib comdlg32.lib shell32.lib comctl32.lib %LINKFLAGS% /OPT:NOWIN98 /MACHINE:%MACHINE% /NODEFAULTLIB /ENTRY:DllMain
if not %ERRORLEVEL% == 0 set EXITCODE=%ERRORLEVEL%

::### Clean up ###::
if exist Sessions.res del Sessions.res
if exist Sessions.obj del Sessions.obj
