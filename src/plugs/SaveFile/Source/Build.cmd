...
rc %RCFLAGS% /R /DRC_VERSIONBIT=%BIT% /Fo"SaveFile.res" "Resources\SaveFile.rc"
if not %ERRORLEVEL% == 0 set EXITCODE=%ERRORLEVEL%
cl %CLFLAGS% SaveFile.c SaveFile.res /LD /link kernel32.lib user32.lib advapi32.lib shell32.lib libc.lib %LINKFLAGS% /OPT:NOWIN98 /MACHINE:%MACHINE% /NODEFAULTLIB /ENTRY:DllMain
if not %ERRORLEVEL% == 0 set EXITCODE=%ERRORLEVEL%
...
if exist SaveFile.ilk del SaveFile.ilk
