...
rc %RCFLAGS% /R /DRC_VERSIONBIT=%BIT% /Fo"LineBoard.res" "Resources\LineBoard.rc"
if not %ERRORLEVEL% == 0 set EXITCODE=%ERRORLEVEL%
cl %CLFLAGS% LineBoard.c LineBoard.res /LD /link kernel32.lib user32.lib gdi32.lib comdlg32.lib %LINKFLAGS% /OPT:NOWIN98 /MACHINE:%MACHINE% /NODEFAULTLIB /ENTRY:DllMain
if not %ERRORLEVEL% == 0 set EXITCODE=%ERRORLEVEL%

::### Clean up ###::
if exist LineBoard.res del LineBoard.res
if exist LineBoard.obj del LineBoard.obj
