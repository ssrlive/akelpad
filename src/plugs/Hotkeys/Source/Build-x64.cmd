...
rc /R /DRC_VERSIONBIT=%BIT% /Fo"Hotkeys.res" "Resources\Hotkeys.rc"
if not %ERRORLEVEL% == 0 set EXITCODE=%ERRORLEVEL%
cl /O1 %CLFLAGS% Hotkeys.c Hotkeys.res /LD /link kernel32.lib user32.lib gdi32.lib advapi32.lib comctl32.lib /OPT:NOWIN98 /MACHINE:%MACHINE% /NODEFAULTLIB /ENTRY:DllMain
if not %ERRORLEVEL% == 0 set EXITCODE=%ERRORLEVEL%
