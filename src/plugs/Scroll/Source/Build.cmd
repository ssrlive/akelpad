...
rc %RCFLAGS% /R /DRC_VERSIONBIT=%BIT% /Fo"Scroll.res" "Resources\Scroll.rc"
if not %ERRORLEVEL% == 0 set EXITCODE=%ERRORLEVEL%
cl %CLFLAGS% Scroll.c Scroll.res /LD /link kernel32.lib user32.lib comctl32.lib %LINKFLAGS% /OPT:NOWIN98 /MACHINE:%MACHINE% /NODEFAULTLIB /ENTRY:DllMain
if not %ERRORLEVEL% == 0 set EXITCODE=%ERRORLEVEL%

::### Clean up ###::
if exist Scroll.res del Scroll.res
if exist Scroll.obj del Scroll.obj
if exist Scroll.lib del Scroll.lib
if exist Scroll.exp del Scroll.exp
if exist Scroll.ilk del Scroll.ilk
