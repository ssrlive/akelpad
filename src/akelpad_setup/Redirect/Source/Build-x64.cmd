...
cl /O1 %CLFLAGS% Redirect.c Redirect.res /link kernel32.lib user32.lib advapi32.lib comdlg32.lib /SUBSYSTEM:WINDOWS /OPT:NOWIN98 /MACHINE:%MACHINE% /NODEFAULTLIB /ENTRY:_WinMain /OUT:"notepad-x64.exe"
if not %ERRORLEVEL% == 0 set EXITCODE=%ERRORLEVEL%
