...
HWND CreateEditWindowA(HWND hWndParent)
{
  ...
  SendMessage(hWndEditNew, AEM_SETEVENTMASK, 0, AENM_SELCHANGE|AENM_TEXTCHANGE|AENM_TEXTINSERT|AENM_TEXTDELETE|AENM_MODIFY|AENM_LINK|AENM_PROGRESS|AENM_SCROLL);
