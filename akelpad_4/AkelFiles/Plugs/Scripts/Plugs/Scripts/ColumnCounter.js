...
//  0    6     0     -6     08    11     0x4      0x0b
//  5    7     5     -5     78    12     0x2      0x0c
// Если строка не содержит числа, то она не обрабатывается.
// Если выделена только одна строка, то выделенное число будет увеличено на величину назначенного шага.
// Если шаг равен нулю, то он будет вычислен автоматически, как разница между вторым и первым числом.
