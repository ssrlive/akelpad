...
rc /R /DRC_VERSIONBIT=%BIT% /Fo"Explorer.res" "Resources\Explorer.rc"
if not %ERRORLEVEL% == 0 set EXITCODE=%ERRORLEVEL%
cl /O1 %CLFLAGS% Explorer.c Explorer.res /LD /link kernel32.lib user32.lib shell32.lib /OPT:NOWIN98 /MACHINE:%MACHINE% /NODEFAULTLIB /ENTRY:DllMain
if not %ERRORLEVEL% == 0 set EXITCODE=%ERRORLEVEL%
