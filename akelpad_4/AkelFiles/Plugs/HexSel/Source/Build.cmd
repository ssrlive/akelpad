...
rc %RCFLAGS% /R /DRC_VERSIONBIT=%BIT% /Fo"HexSel.res" "Resources\HexSel.rc"
if not %ERRORLEVEL% == 0 set EXITCODE=%ERRORLEVEL%
cl %CLFLAGS% HexSel.c HexSel.res /LD /link kernel32.lib user32.lib gdi32.lib %LINKFLAGS% /OPT:NOWIN98 /MACHINE:%MACHINE% /NODEFAULTLIB /ENTRY:DllMain
if not %ERRORLEVEL% == 0 set EXITCODE=%ERRORLEVEL%

::### Clean up ###::
if exist HexSel.res del HexSel.res
if exist HexSel.obj del HexSel.obj
if exist HexSel.lib del HexSel.lib
if exist HexSel.exp del HexSel.exp
if exist HexSel.ilk del HexSel.ilk
