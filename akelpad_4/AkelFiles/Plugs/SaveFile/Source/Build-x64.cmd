...
cl %CLFLAGS% SaveFile.c SaveFile.res /LD /link kernel32.lib user32.lib advapi32.lib shell32.lib %LINKFLAGS% /OPT:NOWIN98 /MACHINE:%MACHINE% /NODEFAULTLIB /ENTRY:DllMain
if not %ERRORLEVEL% == 0 set EXITCODE=%ERRORLEVEL%
