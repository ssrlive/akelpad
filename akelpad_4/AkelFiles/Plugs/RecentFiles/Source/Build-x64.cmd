...
rc %RCFLAGS% /R /DRC_VERSIONBIT=%BIT% /Fo"RecentFiles.res" "Resources\RecentFiles.rc"
if not %ERRORLEVEL% == 0 set EXITCODE=%ERRORLEVEL%
cl %CLFLAGS% RecentFiles.c RecentFiles.res /LD /link kernel32.lib user32.lib gdi32.lib comctl32.lib %LINKFLAGS% /OPT:NOWIN98 /MACHINE:%MACHINE% /NODEFAULTLIB /ENTRY:DllMain
if not %ERRORLEVEL% == 0 set EXITCODE=%ERRORLEVEL%

::### Clean up ###::
if exist RecentFiles.res del RecentFiles.res
if exist RecentFiles.obj del RecentFiles.obj
if exist RecentFiles.lib del RecentFiles.lib
if exist RecentFiles.exp del RecentFiles.exp
if exist RecentFiles.ilk del RecentFiles.ilk
