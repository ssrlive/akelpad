...
rc %RCFLAGS% /R /DRC_VERSIONBIT=%BIT% /Fo"SpecialChar.res" "Resources\SpecialChar.rc"
if not %ERRORLEVEL% == 0 set EXITCODE=%ERRORLEVEL%
cl %CLFLAGS% SpecialChar.c SpecialChar.res /LD /link kernel32.lib user32.lib gdi32.lib comdlg32.lib %LINKFLAGS% /OPT:NOWIN98 /MACHINE:%MACHINE% /NODEFAULTLIB /ENTRY:DllMain
if not %ERRORLEVEL% == 0 set EXITCODE=%ERRORLEVEL%

::### Clean up ###::
if exist SpecialChar.res del SpecialChar.res
if exist SpecialChar.obj del SpecialChar.obj
