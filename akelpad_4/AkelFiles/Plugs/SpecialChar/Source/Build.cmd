...
rc /R /DRC_VERSIONBIT=%BIT% /Fo"SpecialChar.res" "Resources\SpecialChar.rc"
if not %ERRORLEVEL% == 0 set EXITCODE=%ERRORLEVEL%
cl /O1 %CLFLAGS% SpecialChar.c SpecialChar.res /LD /link kernel32.lib user32.lib gdi32.lib comdlg32.lib /OPT:NOWIN98 /MACHINE:%MACHINE% /NODEFAULTLIB /ENTRY:DllMain
if not %ERRORLEVEL% == 0 set EXITCODE=%ERRORLEVEL%
