...
#define AEHLF_QUOTEWITHOUTDELIMITERS 0x002  //Quote doesn't contain delimiters.
#define AEHLF_QUOTEEND_REQUIRED      0x004  //If quote end isn't found, text after quote start will not be highlighted.
#define AEHLF_QUOTESTART_ISDELIMITER 0x008  //Last meet delimiter used as quote start (AEQUOTEITEM.pQuoteStart member is ignored).
#define AEHLF_QUOTEEND_ISDELIMITER   0x010  //First meet delimiter used as quote end (AEQUOTEITEM.pQuoteEnd member is ignored).
#define AEHLF_QUOTESTART_NOHIGHLIGHT 0x020  //Don't highlight quote start string.
#define AEHLF_QUOTEEND_NOHIGHLIGHT   0x040  //Don't highlight quote end string.
#define AEHLF_QUOTESTART_NOMATCH     0x080  //Don't match and don't highlight quote start string.
#define AEHLF_QUOTEEND_NOMATCH       0x100  //Don't match and don't highlight quote end string.
#define AEHLF_QUOTESTART_ATLINESTART 0x200  //Quote start located at line start.
#define AEHLF_QUOTEEND_ATLINEEND     0x400  //Quote end located at line end.
