...
#define AEM_UPDATESEL         (WM_USER + 2020)
#define AEM_GETLINECOUNT      (WM_USER + 2021)
#define AEM_GETINDEX          (WM_USER + 2022)
#define AEM_GETLINEINDEX      (WM_USER + 2023)
#define AEM_UPDATEINDEX       (WM_USER + 2024)
...
#define AEM_GETWORDDELIMITERS (WM_USER + 2056)
#define AEM_SETWORDDELIMITERS (WM_USER + 2057)
#define AEM_SHOWSCROLLBAR     (WM_USER + 2058)
...
#define AEUN_STOPGROUP       0x00000010
#define AEUN_SINGLECHAR      0x00000020
